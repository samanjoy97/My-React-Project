              ...
              <div className="row">
                <div className="col-md-7 pe-0">
                  <div className="form-left h-100 py-5 px-5">
                    <form action="" onSubmit={login} className="row g-4">
                      ...
                      <div className="col-sm-12">
                        <p className="text-centre mt-2">
                          Forget Password?{" "}
                          <Link to="/passwordReset">Click Here to Reset Password</Link>
                        </p>
                      </div>
                      ...
                      <div className="col-12">
                        ...
                        >
                          {buttonClicked ? <div class="d-flex"><i class="spinner-border spinner-border-sm mt-1" role="status" aria-hidden="true"></i><span>Processing...</span></div> : "Login"}
                        </button>
                      </div>
                    </form>
                  </div>
